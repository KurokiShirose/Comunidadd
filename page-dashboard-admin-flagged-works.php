      ...
      <div class="px-3 d-none d-sm-block">
        <div class="card ">
          <div class="card-body ">
            ...
            <div class="row pt-1 px-3">
            <a class="btn btn-menu-active" href='page-dashboard-admin-flagged-works.php'><i class="bi bi-flag-fill"></i> Flagged Works<span class="badge text-white"><?php echo $counts_fworks ?></span> </a>
            </div>
            <div class="row pt-1 px-3">
        ...
        <div class="card" style="border:none;">
          <div class="card-body p-1">
            ...
            <div class="row px-2">
              ...
              <div class="col-3 p-1">
                <a class="btn btn-menu-mob-active stats-mob text-center text-secondary" href='page-dashboard-admin-flagged-works.php'><i class="bi bi-flag-fill"></i><span class="badge text-secondary sm-font">1</span> </a>
              </div>
              <div class="col-3 p-1">
                    ...
                    while($result = mysqli_fetch_array($query)){
                      echo "
                        <div class='d-flex align-content-start flex-wrap'>
                          <div class='p-2'>
                            <a href='./assets/img/works/".$result["work"]."' target='_blank'><img src='./assets/img/works/".$result["work"]."'
                              alt='' class='profile-pic-small'></a>
                          </div>
                          <div class='' style='width:55%;'>
                            <p class='dashboard-item' style='margin-left:2%;'><span class='text-muted'></span><b>".$result["title"]."</b></p>
                            <p class='dashboard-item' style='margin-left:2%;'><span class='text-muted'></span>".$result["first_name"]." ".$result["last_name"]."</p>
                            <p class='dashboard-item' style='margin-left:2%;'><span class='text-muted'></span>".$result["tags"]."</p>
                            <p class='dashboard-item' style='margin-left:2%;'><span class='text-muted'></span>Flagged Date: ".date('M d, Y H:i', strtotime($result["date"]))."</p>
                          ...
                          <div class='m-auto p-2 float-right'>";
                              ...
                              <a href='report.php?remove={$result['flag_id']}' class='btn btn-success' onclick='return confirm(`Are you sure?`);'><i class='fa fa-check-circle'></i> Archive</a>
                              <a href='report.php?pass={$result['flag_id']}' class='btn btn-danger' onclick='return confirm(`Are you sure?`);'><i class='fa fa-times-circle' ></i> Unflag</a> |
                              <a type='button' class='btn btn-custom-reg' style='background-color: rgb(225, 225, 225); color:black' 
                                data-toggle='modal' data-target='#modal-".$result["flag_id"]."' onclick='$('#modal-".$result["flag_id"]."').modal('toggle');'>
                      ...
                      echo "
                        <div id='modal-".$result["flag_id"]."' class='modal fade' tabindex='-1'>
