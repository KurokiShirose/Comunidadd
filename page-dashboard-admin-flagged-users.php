...
<?php
      ...
      <div class="px-3 d-none d-sm-block">
        <div class="card ">
          <div class="card-body ">
            ...
            <div class="row pt-1 px-3">
              <a class="btn btn-menu-active" href='page-dashboard-admin-flagged-users.php'><i class="bi bi-flag"></i> Flagged Users<span class="badge text-white"><?php echo $counts_fusers ?></span></a>
            </div>
            <div class="row pt-1 px-3">
        ...
        <div class="card" style="border:none;">
          <div class="card-body p-1">
            ...
            <div class="row px-2">
              ...
              <div class="col-3 p-1">
                <a class="btn btn-menu-mob-active stats-mob text-center text-secondary" href='page-dashboard-admin-flagged-users.php'><i class="bi bi-flag"></i><span class="badge text-secondary sm-font">1</span></a>
              </div>
              <div class="col-3 p-1">
  ...
  <div class="content-2" style="height:100vh;">
    <div class="container-fluid p-3 overflow-auto" >
      <div class="card" style="border-radius: 10px; border-width: 0ch; background-color: #ffffff; margin: 10px;" >
          <div class="card-body">
            <?php
                ...
                while($result = mysqli_fetch_array($query)){
                  echo "
                    <div class='row d-flex align-content-start flex-wrap'>
                      <div class='col-lg-1 p-2 d-flex align-items-center'>";
                      ...
                      <div class='col-lg-8'>
                        ...
                        <p class='dashboard-item' style='margin-left:2%;'><span class='text-muted'>Date Joined: </span>".date('M d, Y H:i', strtotime($result["date_joined"]))."</p>
                        ...
                        <div class='modal-content'>
                          <form action='report.php' method='post'>
                            ...
                            <div class='modal-body'>
                              <div class='row'>
                                <input type='number' name='userID' value='".$result["user_id"]."' hidden>
                                <input type='text' name='username' value='".$result["username"]."' hidden>
                                <input type='text' name='firstName' value='".$result["first_name"]."' hidden>
                                <input type='email' name='email' value='".$result["email"]."' hidden>
                                <p class='dashboard-item'><b>". $result['first_name']." ". $result['last_name']."</b> (<b>".$result["flags"]." </b> flag/s), ".ucfirst($result["user_type"])."</p>
                            ...
                            <div class='modal-footer justify-content-between'>
                              <button type='submit' name='deleteAccUser' class='btn btn-custom-reg' style='background-color: #822626;'  onclick='return confirm(`Are you sure you want to delete this user profile? This cannot be undone.`);'>Delete Account</button>
