...
<body style="background-color: rgb(229, 229, 229) ;">
  ...
  <div class="container p-0 overflow-hidden">
    ...
    <h4><b>Online Payment</b></h4>
          ...
          <div class="form-group form-group-custom">
            <input type="text" name="serviceProvider" class="form-control" placeholder="Service Provider" value="" />
          </div>
          <div class="form-group form-group-custom">
            <input type="number" name="accNumber" class="form-control" placeholder="Account Number (e.g. XXXX-XXXX-XXXX)" value="" />
          </div>
          <div class="form-group form-group-custom">
            <input type="text" name="accName" class="form-control" placeholder="Account Name" value="" />
          </div>
          <div class="form-group form-group-custom pb-3">
            <textarea name="onlineDetails" placeholder="More Details" class="form-control" id="comment" style="background-color: rgb(244, 246, 246); height:150px; resize: none ;"></textarea>
          </div>
